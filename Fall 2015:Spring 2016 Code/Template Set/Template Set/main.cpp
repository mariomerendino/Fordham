...
int main(){
    ...
    cout << "There cannot be any duplicate values within the set, or Use of the number 0"<<endl;
    Set A, B, C;
    ...
    A= A+interger;
    cout << "Set A: "<< A;
    cout << "Remove one interger from set B (Based on position in the array)" <<endl;
    cin >> spotinarray;
    B= B-spotinarray;
    cout <<"Set B: " << B;
}
