...
public class gradebook{
    ...
    public void addClass(String className){
        ...
        String path = System.getProperty("user.dir") + "data/" + userName  + "/" + c.className + '/' + c.className;  
        
        String gradePath = System.getProperty("user.dir") + "data/" + userName + "/" +c.className + "/grades";

        io.createDirectory(System.getProperty("user.dir") + "data/" + userName + "/class_list");
